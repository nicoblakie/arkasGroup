	...
	*/
	...
	public function rules()
	{
		...
		return array(
			...
			array('fieldname', 'match'
				, 'pattern'=>'/^([a-zA-Z]{3,20})$/'
				, 'message'=>CrugeTranslator::t("solo use de 3 a 20 letras (a-z), sin espacios")
				),
		
			array('position, required, fieldtype, fieldsize, maxlength, showinreports'
				, 'numerical', 'integerOnly'=>true),
				
			array('fieldname, longname, fieldtype, fieldsize, maxlength'
				, 'required'),
