...
//        ));
        ...
        //$this->render('index');
        $noticias = Posts::model()->findAll(array('order' => 'fecha DESC', 'condition' => "`secciones_idSeccion` = 1"));
    ...
    public function actionContact() {
        ...
        if (isset($_POST['ContactForm'])) {
            ...
            if ($model->validate()) {
                ...
                Yii::app()->user->setFlash('Contacto', 'Gracias por contactar con nosotros. Nosotros le responderemos lo antes posible.');
                $this->refresh();
            }
        }
